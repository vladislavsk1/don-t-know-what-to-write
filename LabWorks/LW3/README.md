# In the work we have data, among which there are boundaries of the interval on which we consider the behavior of the function given to us. We create a "table" in which we enter data:
